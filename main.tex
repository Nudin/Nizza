...
\end{equation} % nochy<mal überprüfen ob die Verallgemeinerung stimmt
...
\begin{equation}
q(t+h)=e^{h\OB/2}e^{h\OA}e^{h\OA/2} \label{eq:secondorder}
\end{equation}
...
\begin{equation}
m_0 = M \quad ; \quad m'_{i\neq 0} = m_i \frac{\eta_{i-1}}{\eta_{i}} \quad ; \quad \vec p'_i = m'_i \vec v'_i
\end{equation}
...
\end{equation}
mit $r'_i = \norm{x'_i}$ einmal mit positiven und einmal mit negativen Vorzeichen einfügen:
\begin{equation}
