...
Beim Vergleich mit dem Literaturwert von Jewitt et al. aus dem Jahr 2000 stellen Morbidelli et al. eine deutlich Differenz fest: der berechnete Wert ist um einen Faktor $\sim3-25$ kleiner als der Literaturwert. % O-cite! ###
...
Nach Korrektur dieser erhielte die Gruppe um Morbidelli eine Masse von $1,3 \cdot 10^{-5} M_\oplus$ für die Trojaner. Nachdem 87\% der Trojaner eine Librationsamplitude von unter 30\degree haben, ergibt sich für diese eine Masse von etwa $1,1 \cdot 10^{-5} M_\oplus$, was mit den Werten der Simulationen gut übereinstimmt\cite{Morbidelli2005}.
...
Ein weiterer positiver Aspekt an diesem Model ist, dass er erklärt warum die Trojaner nur sehr wenig Wasser und Organische Stoffe enthalten: %O-Quelle?
